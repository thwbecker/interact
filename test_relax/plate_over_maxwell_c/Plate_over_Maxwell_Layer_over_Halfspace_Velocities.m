function U = Plate_over_Maxwell_Layer_over_Halfspace_Velocities(m,xloc,H1,H2,nu,t,tR1,tR2)
%
% U = Plate_over_Maxwell_Layer_over_Halfspace_Velocities(m,xloc,H1,H2,mu_lam,t,tR1,tR2)
%
...
%  nu  = (scalar) Poisson's ratio (<0.5), uniform
...
%  tR2 = (scalar) Maxwell relaxation time of viscoelastic halfspace -- years%%OUTPUTS:
...
f2_p2=k(j)*(-i*(Mxx-Myy)/4-1/2*Mxy); 
   ...
   F4x4=[F1_0;F2_0;F3_0;0];
    ...
    term11 = Num1*s*exp(s*t)/Den;
    term21 = Num2*s*exp(s*t)/Den;
    
    s=R(3);
    Den = a*s*(s-R(2))*(s-R(4))*(s-R(5))*(s-R(6))*(s-R(7))*(s-R(8));
    Num1 = -( Nu1(1) + Nu1(2)*s + Nu1(3)*s^2 + Nu1(4)*s^3 + Nu1(5)*s^4+ Nu1(6)*s^5+ Nu1(7)*s^6+ Nu1(8)*s^7 );
    Num2 = -( Nu2(1) + Nu2(2)*s + Nu2(3)*s^2 + Nu2(4)*s^3 + Nu2(5)*s^4+ Nu2(6)*s^5+ Nu2(7)*s^6+ Nu2(8)*s^7 );
    term12 = Num1*s*exp(s*t)/Den;
    term22 = Num2*s*exp(s*t)/Den;
  
    s=R(4);
    Den = a*s*(s-R(2))*(s-R(3))*(s-R(5))*(s-R(6))*(s-R(7))*(s-R(8));
    Num1 = -( Nu1(1) + Nu1(2)*s + Nu1(3)*s^2 + Nu1(4)*s^3 + Nu1(5)*s^4+ Nu1(6)*s^5+ Nu1(7)*s^6+ Nu1(8)*s^7 );
    Num2 = -( Nu2(1) + Nu2(2)*s + Nu2(3)*s^2 + Nu2(4)*s^3 + Nu2(5)*s^4+ Nu2(6)*s^5+ Nu2(7)*s^6+ Nu2(8)*s^7 );
    term13 = Num1*s*exp(s*t)/Den;
    term23 = Num2*s*exp(s*t)/Den;
  
    s=R(5);
    Den = a*s*(s-R(2))*(s-R(3))*(s-R(4))*(s-R(6))*(s-R(7))*(s-R(8));
    Num1 = -( Nu1(1) + Nu1(2)*s + Nu1(3)*s^2 + Nu1(4)*s^3 + Nu1(5)*s^4+ Nu1(6)*s^5+ Nu1(7)*s^6+ Nu1(8)*s^7 );
    Num2 = -( Nu2(1) + Nu2(2)*s + Nu2(3)*s^2 + Nu2(4)*s^3 + Nu2(5)*s^4+ Nu2(6)*s^5+ Nu2(7)*s^6+ Nu2(8)*s^7 );
    term14 = Num1*s*exp(s*t)/Den;
    term24 = Num2*s*exp(s*t)/Den;
  
    s=R(6);
    Den = a*s*(s-R(2))*(s-R(3))*(s-R(4))*(s-R(5))*(s-R(7))*(s-R(8));
    Num1 = -( Nu1(1) + Nu1(2)*s + Nu1(3)*s^2 + Nu1(4)*s^3 + Nu1(5)*s^4+ Nu1(6)*s^5+ Nu1(7)*s^6+ Nu1(8)*s^7 );
    Num2 = -( Nu2(1) + Nu2(2)*s + Nu2(3)*s^2 + Nu2(4)*s^3 + Nu2(5)*s^4+ Nu2(6)*s^5+ Nu2(7)*s^6+ Nu2(8)*s^7 );
    term15 = Num1*s*exp(s*t)/Den;
    term25 = Num2*s*exp(s*t)/Den;
  
    s=R(7);
    Den = a*s*(s-R(2))*(s-R(3))*(s-R(4))*(s-R(5))*(s-R(6))*(s-R(8));
    Num1 = -( Nu1(1) + Nu1(2)*s + Nu1(3)*s^2 + Nu1(4)*s^3 + Nu1(5)*s^4+ Nu1(6)*s^5+ Nu1(7)*s^6+ Nu1(8)*s^7 );
    Num2 = -( Nu2(1) + Nu2(2)*s + Nu2(3)*s^2 + Nu2(4)*s^3 + Nu2(5)*s^4+ Nu2(6)*s^5+ Nu2(7)*s^6+ Nu2(8)*s^7 );
    term16 = Num1*s*exp(s*t)/Den;
    term26 = Num2*s*exp(s*t)/Den;
    ...
    Num1 = -( Nu1(1) + Nu1(2)*s + Nu1(3)*s^2 + Nu1(4)*s^3 + Nu1(5)*s^4+ Nu1(6)*s^5+ Nu1(7)*s^6+ Nu1(8)*s^7 );
    Num2 = -( Nu2(1) + Nu2(2)*s + Nu2(3)*s^2 + Nu2(4)*s^3 + Nu2(5)*s^4+ Nu2(6)*s^5+ Nu2(7)*s^6+ Nu2(8)*s^7 );
    term17 = Num1*s*exp(s*t)/Den;
    term27 = Num2*s*exp(s*t)/Den;
...
N3 = N31*Pzsf(1) + N32*Pzsf(2);
    ...
    Den = a2*s*(s-R2(3));
    Num = -( N1 + N2*s + N3*s^2);
    term1 = Num*s*exp(s*t)/Den;
     
    s=R2(3);
    Den = a2*s*(s-R2(2));
    Num = -( N1 + N2*s + N3*s^2);
    term2 = Num*s*exp(s*t)/Den;
