...
/* src/eval_green.c */
void eval_green_and_project_stress_to_fault(struct flt *, int, int, double *, double *, unsigned char, unsigned char, struct el_par);
void eval_green(double *, struct flt *, double *, double *, double [3][3], int *, unsigned char, unsigned char, unsigned char, struct el_par);
...
void eval_2dsegment_plane_strain_basic(double *, struct flt *, double *, double *, double [3][3], int *, struct el_par);
void eval_2dsegment_plane_stress_basic(double *, struct flt *, double *, double *, double [3][3], int *, struct el_par);
...
void eval_okada(double *, struct flt *, double *, double *, double [3][3], int *, unsigned char, unsigned char, struct el_par);
void eval_okada_basic(double *, double, double, double, double, double *, double *, double [3][3], int *, unsigned char, struct el_par);
void eval_point(double *, struct flt *, double *, double *, double [3][3], int *, unsigned char, unsigned char, struct el_par);
void eval_point_short(double *, double *, double, double, double, double, double *, double *, double [3][3], int *, unsigned char, unsigned char, struct el_par);
void set_stress_and_disp_nan(double [3][3], double *, unsigned char);
/* src/green/eval_triangle_gauss.c */
void eval_triangle_gauss(double *, struct flt *, double *, double *, double [3][3], int *, int, unsigned char, double, double);
void get_gauss_points(double *, double *, double *, int);
/* src/green/eval_triangle_nw.c */
void eval_triangle_nw(double *, struct flt *, double *, double *, double [3][3], int *, unsigned char, struct el_par);
...
double bulk_mod_from_G_nu(double, double);
double nu_from_G_bulk(double, double);
...
void ve_effective_elpar(double, double, double, double, struct el_par *);
void ve_spec_homogeneous(struct prony_spec *, double, double, double);
double ve_basis(struct prony_spec *, int, double);
void ve_solve_weights(struct prony_spec *);
double ve_prony_amplitudes_stress(struct prony_spec *, struct med *, struct flt *, int, int, double *, double [6 +1][3][3]);
...
void ve_spec_layered_antiplane(struct prony_spec *, double, double, double, double, int);
