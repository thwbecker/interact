...
void eval_triangle_general(float *, struct flt *, float *, float *, float [3][3], int *, unsigned char, unsigned char, struct el_par);
void eval_green_at_receiver(struct flt *, int, int, float *, float *, float [3][3], int *, unsigned char, unsigned char, unsigned char, struct el_par);
void eval_green_basic(float *, struct flt *, float *, float *, float [3][3], int *, unsigned char, struct el_par);
...
float interaction_coefficient(int, int, int, int, struct flt *, int *, unsigned char, struct el_par);
void get_right_slip(float *, unsigned char, float, struct flt *);
void get_right_slip_no_rake_var(float *, unsigned char, float);
...
void initialize_interact(struct med **, struct flt **, unsigned char, unsigned char, int, unsigned char, unsigned char, float, float *, float *, unsigned char, unsigned char, unsigned char, float, unsigned char, float, unsigned char, unsigned char, unsigned char, unsigned char, unsigned char, unsigned char, unsigned char, short int, unsigned char, float, unsigned char, unsigned char, unsigned char, unsigned char, unsigned char, float, unsigned char, unsigned char, unsigned char, unsigned char, char *, float);
void init_files_interact(struct med **, struct flt **);
void init_parameters_interact(char **, int, unsigned char *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, float *, int *, unsigned char *, unsigned char *, unsigned char *, float *, unsigned char *, float *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, short int *, unsigned char *, float *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, float *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, int *, char *, float *, int);
...
/* src/linear_algebra/eigensystem.c */
...
/* src/linear_algebra/levmarq_numrec.c */
...
/* src/linear_algebra/lusolve.c */
void lu_driver(float *, float *, float *, int, int, struct med *);
/* src/linear_algebra/matrixio.c */
...
/* src/linear_algebra/nnls.c */
void nnls_driver_i(float *, float *, float *, int, int);
/* src/linear_algebra/petsc_simple_solve.c */
...
void par_add_solution_stress(int, unsigned char *, float *, int *, struct med *, struct flt *, float, unsigned char);
...
/* src/linear_algebra/sparse_nr.c */
...
/* src/testing/noda_crack_test.c */
/* src/testing/test_optimize.c */
/* src/testing/test_solvers.c */
...
void eval_2dsegment_plane_strain_basic(float *, struct flt *, float *, float *, float [3][3], int *, struct el_par);
void eval_2dsegment_plane_stress_basic(float *, struct flt *, float *, float *, float [3][3], int *, struct el_par);
...
void get_2dseg_stress(float [3][3], float *, float *, float, float, float, float, struct el_par);
void eval_2dsegment_plane_strain_tdd(float *, struct flt *, float *, float *, float [3][3], int, int *, unsigned char, struct el_par);
void eval_2dsegment_antiplane(float *, struct flt *, float *, float *, float [3][3], int, int *, unsigned char, struct el_par);
void eval_2dsegment_antiplane_basic(float *, struct flt *, float *, float *, float [3][3], int, int *, struct el_par);
void get_2dseg_antiplane_terms(float *, struct flt *, float *, float *, int *);
void get_2dseg_antiplane_ffac(float *, float *, float *, float, float, float, float, float, float *);
/* src/green/eval_iquad.c */
void eval_iquad(float *, struct flt *, float *, float *, float [3][3], int *, unsigned char, struct el_par);
/* src/green/eval_okada.c */
void eval_okada(float *, struct flt *, float *, float *, float [3][3], int *, unsigned char, unsigned char, struct el_par);
void eval_okada_basic(float *, float, float, float, float, float *, float *, float [3][3], int *, unsigned char, struct el_par);
void eval_point(float *, struct flt *, float *, float *, float [3][3], int *, unsigned char, unsigned char, struct el_par);
void eval_point_short(float *, float *, float, float, float, float, float *, float *, float [3][3], int *, unsigned char, unsigned char, struct el_par);
void set_stress_and_disp_nan(float [3][3], float *, unsigned char);
/* src/green/eval_triangle_gauss.c */
void eval_triangle_gauss(float *, struct flt *, float *, float *, float [3][3], int *, int, unsigned char, double, double);
void get_gauss_points(float *, float *, float *, int);
/* src/green/eval_triangle_nw.c */
void eval_triangle_nw(float *, struct flt *, float *, float *, float [3][3], int *, unsigned char, struct el_par);
...
/* src/geometry/divide_fault_in_patches.c */
...
float resolve_stress_on_fault(float [3][3], struct flt *, unsigned char);
