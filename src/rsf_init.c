...
void rsf_print_help(const char *prog)
{
  ...
  fprintf(stderr,"                          No checkpoint is written while an event is in progress;\n");
  fprintf(stderr,"                          one that falls due then is written after the arrest\n");
  ...
  fprintf(stderr,"                          Rows written after that checkpoint by the interrupted run\n");
  fprintf(stderr,"                          are not removed. -ts_max_steps counts steps of this run;\n");
  fprintf(stderr,"                          the monitor step column stays absolute\n");
  fprintf(stderr,"\n");
