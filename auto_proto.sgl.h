...
void add_to_right_hand_side(double, float **, double **, int *);
void add_solution(int, unsigned short *, float *, int *, struct med *, struct flt *, unsigned short, unsigned short, double);
void assemble_a_matrix(float *, int, unsigned short *, int, int *, struct flt *, struct med *);
void assemble_ap_matrix(float *, int, int, unsigned short *, unsigned short *, int, int, int *, int *, struct flt *, struct med *);
/* solve_mode_dependend.c */
void assemble_ap_matrix_4(float *, int, int, unsigned short *, unsigned short *, int, int, int *, int *, struct flt *, struct med *);
